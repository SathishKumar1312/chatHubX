	...
	return (
		<div className='h-screen flex flex-col align-middle justify-center bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-xl rounded-2xl shadow-xl overflow-hidden'>
			<motion.div
				...
				className='mx-auto bg-neutral rounded-2xl shadow-2xl p-8 w-full max-w-md'
			>
				...
				<form onSubmit={handleSubmit} className='space-y-6'>
					...
					<motion.button
						...
						className='w-full bg-gradient-to-r from-blue-500 to-emerald-600 text-white font-bold py-3 px-4 rounded-lg shadow-lg hover:from-blue-600 hover:to-emerald-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 disabled:opacity-50'
					>
